...
e = get_open_filename_ext("", "", environment_get_variable("HOME"), "Select Linux GameMaker Game Unix Executable...");
if (e == "") { directory_destroy(environment_get_variable("HOME") + "/.config/" + game_display_name); game_end(); exit; }
icon = get_open_filename_ext("PNG Icon Files (*.png)|*.png", "", environment_get_variable("HOME"), "Select Linux AppImage PNG Icon File...");
